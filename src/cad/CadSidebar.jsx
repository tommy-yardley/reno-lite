    ...
    <aside className="space-y-6 border-r border-[#D8CCB0] bg-[#F3EEE3]/90 p-4 lg:min-h-[calc(100vh-82px)] lg:p-5">
      <section>
        ...
        <div className="grid grid-cols-2 gap-2">
          <button onClick={() => { cad.setTool("select"); cad.setActiveNodeId(null); }} className="flex items-center justify-center gap-1.5 rounded-md border py-2 text-xs" style={cad.tool === "select" ? { background: "#1B2B3A", color: "#FBF8F1", borderColor: "#1B2B3A" } : { borderColor: "#D8CCB0", color: "#5E86A8" }}>
